...
public class D_ReviewSeeder implements CommandLineRunner {
  ...
  public void run(String...args) throws Exception {
    ...
    if (reviews.size() == 0) {
      ...
      review1.setLocation(locationRepository.findById(1).get());
      ...
      review2.setLocation(locationRepository.findById(2).get());
      ...
      review3.setLocation(locationRepository.findById(3).get());
